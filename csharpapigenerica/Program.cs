...
builder.Services.AddScoped<ITokenService, TokenService>(); // Registra el servicio TokenService como singleton, asegurando una única instancia compartida en toda la aplicación.
